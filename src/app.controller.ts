...
export class AppController {
  ...
  logRequest(@Req() request: Request): string {
    ...
    return 'Check your console for GET!'; // Send a response back to the client
  }
  ...
  logPostRequest(@Body() data: any, @Req() request: Request): string {
    ...
    return 'Check your console for POST!'; // Send a response back to the client
  }
}
